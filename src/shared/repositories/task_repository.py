...
class SqliteTaskRepository():
    ...
    def fetch_task_id(self, task : Task) -> int :
        '''Method used only in the offline terminal version.'''
        # Select the id for selection in the timer_data table.
        if task.subtask :
        ...
        return self.connexion.execute(query,task.__dict__).fetchone()[0]
